...
using psqt_vec_t = __m256i;
    ...
    #define vec_mullo_16(a, b) _mm512_mullo_epi16(a, b)
    #define vec_mulhi_u16(a, b) _mm512_mulhi_epu16(a, b)
...
using psqt_vec_t = __m256i;
    ...
    #define vec_mullo_16(a, b) _mm256_mullo_epi16(a, b)
    #define vec_mulhi_u16(a, b) _mm256_mulhi_epu16(a, b)
...
using psqt_vec_t = __m128i;
    ...
    #define vec_mullo_16(a, b) _mm_mullo_epi16(a, b)
    #define vec_mulhi_u16(a, b) _mm_mulhi_epu16(a, b)
...
inline __m256i lasx_packus_32(__m256i a, __m256i b) {
    ...
    #define vec_mullo_16(a, b) __lasx_xvmul_h(a, b)
    #define vec_mulhi_u16(a, b) __lasx_xvmuh_hu(a, b)
    #define vec_srli_16(a, b) __lasx_xvsrli_h(a, b)
...
inline __m128i lsx_packus_32(__m128i a, __m128i b) {
    ...
    #define vec_mullo_16(a, b) __lsx_vmul_h(a, b)
    #define vec_mulhi_u16(a, b) __lsx_vmuh_hu(a, b)
    #define vec_srli_16(a, b) __lsx_vsrli_h(a, b)
